...
type FractalPreset struct {
	...
	DiameterCX          *big.Float `json:"diameterCX"`
	CenterCX            *big.Float `json:"centerCX"`
	CenterCY            *big.Float `json:"centerCY"`
	ColorPreset         string     `json:"colorPreset"`
	JuliaKi             *big.Float `json:"juliaKi"`
	JuliaKr             *big.Float `json:"juliaKr"`
